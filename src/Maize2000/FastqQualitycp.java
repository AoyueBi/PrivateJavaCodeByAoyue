...
public class FastqQualitycp {
    ...
    private void alignBWA () {
        String bwaPath = "/Users/Aoyue/software/bwa-0.7.17/bwa";
        String indexFileS = "/Users/Aoyue/Documents/Data/wheat/ABD/bwaLib/abd_iwgscV1.fa.gz";
        String inputDirS = "/Users/Aoyue/Downloads/huadagene/testSampleData";
    ...
    private void sampleReads () {
        String infileDirS = "/Users/Aoyue/Downloads/huadagene/testRawData";
        String outputDirS = "/Users/Aoyue/Downloads/huadagene/testSampleData";
        int readNum = 100000;
    ...
    private void listSpecificalFiles() {
        ...
        try {
            ...
            for (int i = 0; i < fs.length; i++) {
                ...
                sb.append(fs[i].getName()).append("\t").append(df.format(qq));
